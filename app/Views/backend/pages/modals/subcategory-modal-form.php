<div class="modal fade" id="subcategories-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?= route_to('add-subcategory') ?>" method="post" class="modal-content"
            id="add_subcategories_form">
