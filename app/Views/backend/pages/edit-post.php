...
<form action="<?= route_to('update-post') ?>" method="post" enctype="multipart/form-data" autocomplete="off"
    id="editPostForm">
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" class="form-control" cols="30" rows="10"
                            placeholder="Type..."
                            user-id="<?= $post_data->author_id ?>"><?= $post_data->content ?></textarea>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_keywords" class="form-control" id=""
                            placeholder="enter post meta keyword" value="<?= $post_data->meta_keywords ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" class="form-control" cols="30" rows="10"
                            placeholder="Type meta description..."><?= $post_data->meta_description ?></textarea>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="category" class="custom-select form-control">
                            ...
                            <?php foreach ($categories as $category): ?>
                                <option <?= $category->id === $post_data->category_id ? "selected" : "" ?>
                    ...
                    <div class="form-group">
                        <div class="mb2 mt-1 form-group" style="max-width:100px">
                            <img src="/images/posts/<?= $post_data->featured_image ?>" alt="" class="img-thumbnail"
                                id="post-featured-image-preview">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Tags" name="tags"
                            data-role="tagsinput" value="<?= $post_data->tags ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" name="visibility" id="customRadio1" class="custom-control-input"
                                value="1" <?= $post_data->visibility == 1 ? 'checked' : '' ?>>
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" name="visibility" id="customRadio2" class="custom-control-input"
                                value="0" <?= $post_data->visibility == 0 ? "checked" : "" ?>>
