    ...
    public function sendPasswordResetLink()
    {
        ...
        if (!$isValid) {
            ...
            if (sendEmail($mailConfig)) {
                return redirect()->route('admin.forgot.form')->with('success', 'we have a e-mailed your password reset link.');
            } else {
        ...
        $isValid = $this->validate([
            'new_password' => [
                ...
                'errors' => [
                    ...
                    'is_password_strong' => 'new characters must contains atleast 1 uppercase, 1 lowercase, 1 number and 1 special character.'
                ]
            ],
        ...
        if (!$isValid) {
            ...
            if (!$get_token) {
                ...
                if (sendEmail($mailConfig)) {
                    ...
                    return redirect()->route('admin.login.form')->with('success', 'Done!, Your password has been changed. Use new password to login info system');
                } else {
